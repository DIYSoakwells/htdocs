...
<!-- Modal Header-->				
	<div class="modal-header">
		...
		<h3 class="modal-title cart_summary">
			<span class="cart_diy_logo">DIY&nbsp;SOAKWELLS<small class="trademark">&trade;</small></span><b>Cart Summary</b></h3>		
	</div>
...
<!-- Customer Details Form -->
	<section class="details_form">
		...
		<form name="form" id="form" class="contact_form">
		<fieldset>					
		...
		<div class="captcha_container">
			<div class="g-recaptcha" data-sitekey="6Le8iBkTAAAAAAbuIjairSM-KmzeCvzZRO3FePZO" data-size="compact">
			</div>
		</div>
		...
		<fieldset class="submit">
			<input type="submit" name="Submit" type="submit" id="submit" style="cursor:pointer" formaction="javascript:simpleCart.checkout()"/>
