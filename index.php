...
<head>
	...
	<meta name=description content="Product infotmation on the 140 litre trafficable polypropylene soakwell" />
	<meta name=keywords content="poly, soakwells, diy, 140 litre, perth, polyproplylene, versitank, geotextile, geofabric, drainwell, western australia, supply, atlantis, soak, poly, well" />

	<title>DIY Soakwells&trade; Perth | Polypropylene Soakwell Supply and Delivery</title>
   ...
   <header>
	...
	<section  id="top_link">
   	...
   	<div id="section-video">
    	<div class="video_container row no-gutters">
     
    		<img class="col-sm-4 hidden-xs" src="assets/images/video_images/tank_poster2.jpg" alt="1 polypropylene soakwell"/>
     
    		<img class="col-sm-4 col-xs-12" src="assets/video/animation1---1tank.gif" alt="Polypropylene Soakwell animation"/>
     
     		 <img class="col-sm-4 hidden-xs" src="assets/images/video_images/tank_poster3.jpg" alt="2 polypropylene soakwells"/>
...
You can view individual item quantities from the cart at anytime without leaving the page by clicking on the cart button at the top left of the page.</small></p>
			...
			<!-- Pipe and Fittings -->
			<section class="row">
				<?php include 'includes/content/pipe_and_fittings.php' ;?>
			</section>
...
<div class="heading_container" id="layout_link">
	...
	<section class="main_section">
		...
		<section>
		<?php include 'includes/content/information.php' ;?>
		</section>
	...
	<!--FOOTER -->
	<!--===============================================================-->
	<section class="main_section footer-bottom">
       
   	 	<div class="back_to_top">
        	<a class="nav btn-tiny btn" href="#top_link">Back to top</a>  
        
        	<h3 class="copyright">2016 &copy; DIY Soakwells&trade;All Rights Reserved</h3>
    	</div>
...
<?php include 'includes/modals/cart_modal.php'; ?>

<?php include 'includes/modals/calc_modal.php'; ?>

<?php include 'includes/modals/geo_details_modal.php'; ?>

<?php include 'includes/modals/140_details_modal.php'; ?>
